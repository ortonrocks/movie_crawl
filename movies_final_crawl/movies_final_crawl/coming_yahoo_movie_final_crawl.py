...
def coming_movie_crawl():
    with open('data/coming_movie_info.csv','w',newline='',encoding='utf-8') as csvfile:
    ...
    for page in range(1,7):
        ...
        for url in total:
            ...
            with open('data/coming_movie_info.csv','a+',newline='',encoding='utf-8') as csvfile:
                writer = csv.writer(csvfile)
